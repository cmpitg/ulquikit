...
(defun take-while (fn xs)
  "Starting from the beginning of `xs' builds a new list with the same order
until `fn' returns `nil'"
...
(define-test test-take-while
  ...
  (assert-equal '(2 3 4) (take-while #'evenp '(2 3 4)))
