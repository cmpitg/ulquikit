...
(defun get-snippet-type (snippet)
  "Extracts snippet type.  `snippet' is one of the following formats: .file::
or .code::

TODO: Make this extensible."
  (multiple-value-bind (_ res) (scan-to-strings "\.(file|code)::" snippet)
    (declare (ignore _))
    (->keyword (aref res 0))))
