...
(defun is-block-delimiter? ()
  t)

(in-package #:ulquikit-tests)

(deftest is-block-delimiter? ()
  (is (equal t   (is-block-delimiter? "----")))
  (is (equal nil (is-block-delimiter? " ----")))
  (is (equal t   (is-block-delimiter? "---- ")))
  (is (equal t   (is-block-delimiter? "----  ")))
  (is (equal nil (is-block-delimiter? "----a"))))
