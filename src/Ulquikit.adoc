...
Ulquikit is an extensible literate programming which supports multiple markup
languages and user-friendly interface.
...
* A *code block* is an AsciiDoc/Markdown/whatever markup language you use code
  block.
