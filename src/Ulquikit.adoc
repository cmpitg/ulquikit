...
main package is called `ulquikit`, along comes its test counterpart
`ulquikit-tests`.  For testing, I decide to use
...
(defpackage #:ulquikit-cmd-generate-src
  (:use :cl :command-core))

(in-package #:ulquikit-cmd-generate-src)
