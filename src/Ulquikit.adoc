...
;; (extract-snippets #p"/tmp/cmpitg/ulquikit/test-extract-snippets/")
;; (extract-snippets-from-file "/tmp/cmpitg/ulquikit/test-extract-snippets/lib/Say-Hello.adoc")
;; (collect-snippet (make-snippets) (extract-snippets-from-file "/tmp/cmpitg/ulquikit/test-extract-snippets/lib/Say-Hello.adoc"))
...
")))
    ...
    (let* ((snippets (extract-snippets test-dir))
           (file-snippets (alexandria:hash-table-alist (snippets-file snippets)))
           (code-snippets (alexandria:hash-table-alist (snippets-code snippets))))
      (assert-equal 1 (length file-snippets))
      (assert-equal 2 (length code-snippets))
...
\(say-world\)
"
                    (alexandria:assoc-value file-snippets "/tmp/main.lisp"))
      (assert-equal "\(defun say-hello \(\)
  \(format t \"Hello \"\)\)"
                    (alexandria:assoc-value code-snippets "say-hello"))
      (assert-equal "\(defun say-world \(\)
  \(format t \"world!~%\"\)\)"
                    (alexandria:assoc-value code-snippets "say-world")))))
