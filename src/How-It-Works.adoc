...
And of course, here is help string for +generate-src+:
...
Generate source code from a location to another location.
  ...
  --from Location of the literate source code, default: "src"
  --to   Location of the generated source code, default: "generated-src"
