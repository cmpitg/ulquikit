...
and <<command/generate-html,generate-html>> commands.

.code::schiffer/generate-all
[source,racket,linenums]
----
(define (generate-all #:from [from "src"]
                      #:to-html [to-html "generated-html"]
                      #:to-src  [to-src  "generated-src"])
  (system (str "ulqui generate-src"
               " --from " from
               " --to "   to-src))
  (system (str "ulqui generate-html"
               " --from " from
               " --to "   to-html)))
