...
* Snippet A includes snippet B, then snippet B includes snippet A again,
  creating an infinite loop.  To prevent this, a list of currently included
...
(define (do-include-snippet boxed
                            target
                            included?)
  ;; (pretty-display (~a "processing: " target))
  ...
  (unless (target 'processed)
    (let* ([lines
            (for/list ([line (target 'lines)])
              (if (is-include-directive? line)
                  (let* ([included-snippet-name (get-included-snippet-name line)]
                    ...
                    (cond [(or (included? included-snippet-name)
                          ...
                          [else
                           ...
                           (do-include-snippet boxed
                                               snippet-to-include
                                               (included? included-snippet-name #t))
      ...
      ;; (pretty-display (~a "-> after processing: " new-snippet))
      )))
         ...
         [snippets {'file {"/tmp/tmp.rkt" file-snippet-tmp}
                    'code {"A" {'name "A"
                           ...
                           "B" {'name "B"
                                ...
                                'linenum 30}}}]
         [boxed (box snippets)])
    (do-include-snippet boxed file-snippet-tmp {})
